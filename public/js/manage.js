...
if (local != null) {
    if (local.date && local.code1 && local.code2 && local.trans_obj) {
        for (let i = 0; i < local.date.length; i++) {
            // creer les tds
...
bouton.onclick = () => {
    ...
    if (new_date && new_trans_obj && new_code1 && new_debit1 && new_credit1 && new_code2 && new_debit2 && new_credit2) {
